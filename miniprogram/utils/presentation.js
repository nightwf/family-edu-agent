...
function deriveChildPresentation(input) {
  ...
  if (!child) {
    return {
      state: "stable", image: STATE_ASSETS.stable, title: "先建立孩子档案",
...
module.exports = { SCENES, STATE_ASSETS, dailyScene, deriveChildPresentation, shouldAnimate, dateKey };
