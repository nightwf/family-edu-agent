...
Page({
  ...
  goEducation(){const name=this.data.child&&this.data.child.name?encodeURIComponent(this.data.child.name):"";wx.navigateTo({url:`/pages/child-education/child-education?childId=${this.data.childId}&name=${name}`});},
