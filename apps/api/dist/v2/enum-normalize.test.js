...
import { EnumValueError, EVIDENCE_TYPES, KNOWLEDGE_RELATION_TYPES, PLAN_ITEM_STATUSES, PLAN_ITEM_TYPES, enumHint, normalizeEnumValue, optionalEnumValue, requireEnumValue, } from "./enum-normalize.js";
describe("枚举取值归一化", () => {
    it("英文枚举键直接通过", () => {
