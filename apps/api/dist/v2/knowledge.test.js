...
const { importSourceDocument, saveKnowledgeRelationsBatch, getKnowledgeContext, upsertChildKnowledgeState, } = await import("./knowledge.js");
describe("knowledge v2", () => {
    ...
    it("saves prerequisite relations with hard/soft strength and reason", async () => {
        ...
        expect(relationCreate).toHaveBeenCalledWith(expect.objectContaining({
            data: expect.objectContaining({
                familyId: "family-1",
