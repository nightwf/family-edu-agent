...
import { allowedToolNames, filterChildrenResult, isToolAllowed, normalizePersona, sanitizeToolArguments, } from "./tool-policy.js";
describe("工具授权表", () => {
    it("默认拒绝：未列出的工具不可用", () => {
...
describe("孩子列表收敛", () => {
    it("孩子模式只返回钉住的那一个孩子", () => {
        ...
        const filtered = filterChildrenResult("child_tutor", "child-1", payload);
    ...
    it("家长模式不收敛，能看到全部孩子", () => {
        ...
        const filtered = filterChildrenResult("parent_coach", "child-1", payload);
